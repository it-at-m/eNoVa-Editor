The __eNoVa Editor__ can open files in the [XJustiz.enova. 2900003](https://xjustiz.justiz.de/Anwendungsfaelle/eNoVA/index.php) that were submitted via the [beBPo](https://de.wikipedia.org/wiki/Besonderes_elektronisches_Beh%C3%B6rdenpostfach) in a condensed, human-readable format. Furthermore, the case worker can enter their decision and thus create an XJustiz response file.
...
Every Friday, 2 p.m. (german time) we make a open meeting at https://meet.jit.si/eNoVa-Editor to answer questions.
